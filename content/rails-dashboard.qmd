...
<div class="card"> <div class="card-body"> <h5 class="card-title">About this table</h5> <p class="card-text"> Recording specifications varied according to details laid out in this table. </p> </div> </div>
