...
# birdnet_rails_sub <- birdnet_rails_48c %>%
...
::: {.column width="100%"}  
::: {style="border: 1px solid #ccc; border-radius: 8px; padding: 15px; background-color: white; height: 100%;"}
Interactive map with deployments at Tijuana Estuary and Sweetwater Proving Pens (at Living Coast Discovery Center). Zoom in to see exact locations of recorders, including the distribution of recorders around the proving pens for the detection distance study.  
:::
:::
:::
:::
...
::: {.column width="100%"}  
::: {style="border: 1px solid #ccc; border-radius: 8px; padding: 15px; background-color: white; height: 100%;"}
Interactive table showing all recorder deployments. We recommend viewing this on the full screen. Scroll to the bottom of the table and click on the < > symbol at the bottom right corner to open the table to full view.  
:::
:::
:::
:::
...
::: {.column width="100%"}  
::: {style="border: 1px solid #ccc; border-radius: 8px; padding: 15px; background-color: white; height: 100%;"}
Three different recording configurations were used. Continuous recording at 48 kHz (48c) provided information on diurnal variation. Sampling at Sunrise and Sunset (48s+s) provided recordings during the time when rails (and most other birds) are highly vocal. These recordings included 1 hour before and after sunrise/sunset; while these limited our ability to distinguish diurnal variation, the recording extended for a few weeks. The high frequency sampling (192b) sampled from sunset TO sunrise (night) and allowed for detection of bats.
:::
:::
:::
:::
...
numRails <- nrow(birdnet_rails_48c)
...
# Percentage of recordings with calls that contain Rail calls
railRec <- n_distinct(birdnet_rails_48c$begin_path)
allRec <- n_distinct(birdnet_48c$begin_path)
...
## Summary Rail Detections {.tabset}
### Daily Detections
::: {.row}
::: {style="background-color: #e6f2ff; padding: 20px; border-radius: 8px;"}
...
library(htmltools)
library(knitr)
DetBox <- plotDetectionBoxplot(x=myData_rails_48ss, group='species', facet='location', bin='hour/day', combineYears=FALSE, title = "Detection of Ridgeway's Rails (hours/day) at the Sweetwater Proving Pens and Tijuana Estuary")
...
::: {.column width="100%"}  
::: {style="border: 1px solid #ccc; border-radius: 8px; padding: 15px; background-color: white; height: 100%;"}
Detections of sounds attributed to Ridgway's Rails at Sweetwater Proving Pens (SPP) and Tijuana Estuary (TJE). Calls were not validated, and we expect there to be some degree of false positives (calls falsely attributed to rails) and false negatives (missed calls). 
...
::: {.column width="100%"}  
::: {style="border: 1px solid #ccc; border-radius: 8px; padding: 15px; background-color: white; height: 100%;"}
Diurnal variation in detection of calls attributed to Ridgway's Rails. 
...
# Total # Detections
numDetections <- nrow(birdnet_48c)
...
::: {.column width="100%"}  
::: {style="border: 1px solid #ccc; border-radius: 8px; padding: 15px; background-color: white; height: 100%;"}
Top 10 species detected at Tijuana Estuary (TJE) over the duration of the pilot study.  
...
::: {.column width="100%"}  
::: {style="border: 1px solid #ccc; border-radius: 8px; padding: 15px; background-color: white; height: 100%;"}
Acoustic Scene for top ten species detected at Tijuana Estuary (TJE) over the duration of the pilot study. 
